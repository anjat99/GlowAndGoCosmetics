<?php
    ...
    if(isset($_SESSION['korisnik']) && $_SESSION['korisnik']->naziv==='admin'):
        ...
        require_once("../../modules/kategorije/functions.php"); 
?>
...
<body>
            ...
            <div class="row col-lg-9 bg-light ml-auto" id="sadrzajAdmin">
                    <div class="row col-lg-12">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title  d-flex justify-content-between">Kategorije<span>
                                    <input type="button" value="Dodaj" id='dodajKategoriju'class='btnAdminUpdate btn-primary col-lg-12'>
                                    </span></h4>
                                        <div class="table-responsive" id="tabelaKategorije">
                                        
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 mx-auto" id="podaciKat">
                                                <form method="POST" action="../../modules/kategorije/updateKat.php">
                                                    <div class="form-group">
                                                        <input type="hidden" name="skrivenoPoljeKat" id="skrivenoPoljeKat" class=form-control>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" name="tbNazivKat" id="tbNazivKat" placeholder='Naziv kategorije' class='form-control'>
                                                    </div>
                                                                
                                                    <input type="submit" value="Izmeni" name='btnIzmenaKat' id='btnIzmenaKat' class='btnAdmin btnIzmenaStyle'>
                                                    <input type="button" value="Sakrij" id='sakrijFormuZaKategorije' class='btnAdmin btnIzmenaStyle'>
                                                </form>
                                            </div>

                                            <div class="odgovorUpdateKat">
                                ...
                                <div class="row">
                                            <div class="col-md-4 mx-auto" id="podaciKatDodaj">
                                                <h2>Dodaj kategoriju</h2>
                                                <form method="POST" action="../../modules/kategorije/addKat.php">
                                                    <div class="form-group">
                                                        <input type="hidden" name="skrivenoPoljeKat" id="skrivenoPoljeKat" class=form-control>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" name="tbNazivKat" id="tbNazivKat" placeholder='Naziv brenda' class='form-control mr-2'>
                                                    </div>
                                                                
                                                    <input type="submit" value="Dodaj" name='btnDodajKat' id='btnDodajKat' class='btnAdmin btnIzmenaStyle'>
                                                    <input type="button" value="Sakrij" id='sakrijFormuZaKatDodaj' class='btnAdmin btnIzmenaStyle'>
                                                </form>
                                            </div>
    ...
    <script src="../../assets/js/kategorije.js" type="text/javascript" ></script>   
</body>
</html>