<?php
    ...
    if(isset($_SESSION['korisnik']) && $_SESSION['korisnik']->naziv==='admin'):
        ...
        require_once("../../modules/orders/functions.php"); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="row col-lg-9 bg-light ml-2" id="sadrzajAdmin">
                    <div class="row col-lg-12">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Porudzbine korisnika</h4>
                                        <div class="table-responsive" id="tabelaZaPorudzbine">
                                            <!--TABELA PORUDZBINA -->
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 mx-auto" id="podaciPorudbine">
                                                <!--DETALJI ODREDJENE PORUDZBINE -->
                                            </div>
                                        </div>
                                        <?php endif;?>
                                </div>
